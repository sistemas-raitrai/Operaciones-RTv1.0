...
function ajustarSaltosConfirmacion(work){
  ...
  */
  ...
  documentos.forEach(docEl => {
    ...
    */
    ...
    const equipajeRect =
      equipaje.getBoundingClientRect();
  ...
  */
  ...
  return `
    <div class="print-doc confirm-doc">
      ...
      <div class="sec confirm-equipaje">
      ...
      <div class="sec confirm-recomendaciones">
...
function getEquipajePreliminar(grupo, vuelosNorm){
  ...
  if (!isRegular && isLatam){
    return [
      'Cada persona podrá transportar una maleta de hasta 20 kg más un bolso de mano de 5kg, ambos debidamente marcados con nombre y número de contacto',
  ...
  if (!isRegular && isSky){
    return [
      'Cada persona podrá transportar una maleta de hasta 23 kg más un bolso de mano de 5kg, ambos debidamente marcados con nombre y número de contacto',
      'La aerolínea no permite agregar equipaje adicional ni sobrepeso para este tipo de vuelos.',
    ];
  }

  return [
    'Las condiciones de equipaje dependerán de la tarifa aérea asociada al viaje. Generalmente permite transportar una maleta de hasta 23 kg más un bolso de mano de 5kg, ambos debidamente marcados con nombre y número de contacto',
  ];
}
