...
async function loadVenta(ventas) {
  ...
  // intentar normalizar destino (solo override si hay match)
  ...
  // preseleccionar hoteles coincidentes
  const origText = v.hotel || '';
  (HOTELES_POR_DESTINO[elems.destino.value] || []).forEach(h => {
